    ...
    mainContainer.innerHTML = `
            <div class="main__game">
                ...
                <div class="ship__container">
                    ...
                    <button id="confirm_btn" style="visibility: hidden">Confirm</button>
                </div>
